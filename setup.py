...
setup(
    ...
    description="A Python Package for NLP Obfuscation using Differential Privacy",  # Optional
    ...
    # above.
    author_email="francescoluigi.defaveri@phd.unipd.it",  # Optional
    ...
    # larger catalog.
    keywords=["Differential Privacy", "NLP", "Obfuscation"],  # Optional
